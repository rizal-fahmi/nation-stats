...
function Navbar() {
  return (
    <>
      <nav className="bg-white dark:bg-gray-900 border-b border-gray-400">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          >
            <img
              ...
              alt="Flowbite Logo"
            />
            <span className="self-center text-2xl font-bold whitespace-nowrap dark:text-white text-gray-600">
              NationStats
            </span>
          </Link>
          <button
