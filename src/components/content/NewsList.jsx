...
const NewsList = ({ news }) => {
  return (
    <div className="flex flex-wrap justify-center gap-6 my-8 max-w-screen-lg mx-auto">
      {news.map((n, i) => (
        <article
          key={'news-' + i}
          className="max-w-xs bg-white border border-gray-200 rounded-t-2xl shadow dark:bg-gray-800 dark:border-gray-700"     >
          <Link to={n.web_url}>
            <img
          ...
          <div className="p-4"> {/* Mengurangi padding */}
            <Link to={n.web_url}>
