...
export default function Compare() {
  ...
  return (
    <>
      <div className="flex flex-col items-center h-screen max-w-screen-lg mx-auto">
        ...
        <div className="grid sm:grid-cols-1 lg:grid-cols-2 sm:gap-4 w-full mb-12">
          <InputCompare countries={countries} onSelect={setCca2_1} selectedCountry={cca2_2} />
          <InputCompare countries={countries} onSelect={setCca2_2} selectedCountry={cca2_1} />
        </div>
